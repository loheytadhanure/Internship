    ...
    < form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <select onChange={(e) => setCategory(e.target.value)} value={category} className='w-full py-2'>
        ...
        <div>
          ...
          <select onChange={(e) => setSubCategory(e.target.value)} value={subCategory} className='w-full py-2'>
            <option value="Topwear">Topwear</option>
            <option value="Bottomwear">Bottommwear</option>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          ...
          <div onClick={() => setSizes(prev => prev.includes("L") ? prev.filter(item => item !== 'L') : [...prev, 'L'])}>
            <p className={`${sizes.includes("L") ? "bg-pink-100" : "bg-slate-200"}   bg-slate-200 px-3 py-1 cursor-pointer`}>M</p>
          </div>
          <div onClick={() => setSizes(prev => prev.includes("M") ? prev.filter(item => item !== 'M') : [...prev, 'M'])}>
            <p className={`${sizes.includes("M") ? "bg-pink-100" : "bg-slate-200"}   bg-slate-200 px-3 py-1 cursor-pointer`}>L</p>
          </div>
          <div onClick={() => setSizes(prev => prev.includes("XL") ? prev.filter(item => item !== 'XL') : [...prev, 'XL'])}>
